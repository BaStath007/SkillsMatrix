    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesPerSkill", x => new { x.SkillId, x.SkillCategoryId });
                    table.ForeignKey(
                        name: "FK_CategoriesPerSkill_SkillCategories_SkillCategoryId",
                        column: x => x.SkillCategoryId,
                        principalTable: "SkillCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriesPerSkill_Skills_SkillId",
                        column: x => x.SkillId,
                        principalTable: "Skills",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "CategoriesPerTeam",
                columns: table => new
                {
                    TeamId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    TeamCategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesPerTeam", x => new { x.TeamId, x.TeamCategoryId });
                    table.ForeignKey(
                        name: "FK_CategoriesPerTeam_TeamCategories_TeamCategoryId",
                        column: x => x.TeamCategoryId,
                        principalTable: "TeamCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoriesPerTeam_Teams_TeamId",
                        column: x => x.TeamId,
                        principalTable: "Teams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TeamPositions", x => new { x.TeamId, x.PositionId });
                    table.ForeignKey(
                        name: "FK_TeamPositions_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AccreditedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    AccreditedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Mastery = table.Column<int>(type: "int", nullable: false),
                    UpdatedMasteryAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedMasteryBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoriesPerSkill_SkillCategoryId",
                table: "CategoriesPerSkill",
                column: "SkillCategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_CategoriesPerTeam_TeamCategoryId",
                table: "CategoriesPerTeam",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeamPositions_PositionId",
                table: "TeamPositions",
                column: "PositionId");
